...
public class PostService {
    ...
    public void addPost(Post post){
        User user = userRepository.findUserByUser_id(post.getAuthor_id());
    ...
    public void updatePost(Integer id , Post post){
        ...
        post1.setAuthor_id(post.getAuthor_id());
    ...
    public List<Post> getAllPostByAuthor(Integer author_id){
        if(postRepository.PostByAuthor_id(author_id).isEmpty()){
            throw new ApiException("no post with this author");
        }

        return postRepository.PostByAuthor_id(author_id);
    }
