...
public class CommentService {
    ...
    public void addComment(Comment comment){
        User user = userRepository.findUserByUser_id(comment.getAuthor_id());
    ...
    public void updateComment(Integer id , Comment comment){
        ...
        oldComment.setAuthor_id(comment.getAuthor_id());
    ...
    public List<Comment> getByAuthor(Integer author_id){
        if(commentRepository.commentByAuthor(author_id).isEmpty()){
            throw new ApiException("no comments for this author");
        }

        return commentRepository.commentByAuthor(author_id);
    }
}
