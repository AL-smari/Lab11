...
public class PostController {
    ...
    @GetMapping("/getByAuthor/{author_id}")
    public ResponseEntity getAllPostByAuthor (@PathVariable Integer author_id){

        return ResponseEntity.status(HttpStatus.OK).body(postService.getAllPostByAuthor(author_id));
    }
