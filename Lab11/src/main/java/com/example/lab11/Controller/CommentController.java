...
public class CommentController {
    ...
    public ResponseEntity getCommentByAuthor(@PathVariable Integer author_id){

        return ResponseEntity.status(HttpStatus.OK).body(commentService.getByAuthor(author_id));
    }
}
